...
(** Draws a point within a given graphics context*)
val draw_point : gctx -> position -> unit

(** Draws a series of points within a given graphics context*)
val draw_points : gctx -> position list -> unit

(** Sets the line thickness parameter in gctx*)
val with_thickness : gctx -> bool -> gctx 

(*
(** Makes a line thick*)
val make_thick : gctx -> unit

(** Makes a line thin*)
val make_thin : gctx -> unit
*)
